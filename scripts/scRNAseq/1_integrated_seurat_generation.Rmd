...
new_metadata <- new_metadata %>%
                  mutate(clonotype_shared_tissues = case_when(is.na(clonotype_tissue_groups) ~ NA_character_,
                                                   ...
                                                   tissue != "pancreas"  & clonotype_tissue_groups %in% c("pLN&blood", "pLN", "blood") ~ "periphery non-PM"))
seurat_integrated <- AddMetaData(seurat_integrated, new_metadata)
seurat_integrated$clonotype_shared_tissues <- factor(seurat_integrated$clonotype_shared_tissues, levels = c("pancreas PM", "pancreas non-PM", "pLN PM", "blood PM", "periphery non-PM"))
```
