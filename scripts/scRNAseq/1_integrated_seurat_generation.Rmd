...
seurat_integrated <- AddMetaData(seurat_integrated, new_metadata)
seurat_integrated$clonotype_shared_tissues <- factor(seurat_integrated$clonotype_shared_tissues, levels = c("pancreas shared", "pancreas non-shared", "pLN shared", "blood shared", "periphery non-shared"))
```
