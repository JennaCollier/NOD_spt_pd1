...
p_termexh_clonotypes <- clonotypes_means %>%
    filter(!(seurat_clusters %in% c("CD8_cm", "CD8_cm_Gzmm", "Proliferating", "CD8_pexh"))) %>% #remove clusters with few cells/not interesting
...
grid.arrange(p_termexh_clonotypes, p_eff_clonotypes, ncol = 1)
