...
p_allcells_shared <- seurat_integrated@meta.data %>% 
                      ...
                      labs(x = 'UMAP 1', 
                           y = 'UMAP 2', 
                           color=NULL,
                           title = "All T cells: Clonotypes shared with pancreas") +
...
p_termexh_clonotypes <- clonotypes_means %>%
                          filter(seurat_clusters %in% c("CD8_eff_Cxcr6", "CD8_mem", "CD8_texh", "CD8_effmem", "Acinar_contaminated")) %>% #remove clusters with few cells/not interesting
