...
p_expansion <- seurat_integrated@meta.data %>% 
    ...
    labs(color= NULL,
         title = NULL) +
    scale_color_gradient(na.value ="grey90",low = "black", high = "red", breaks = c(0.5,2)) +
...
memory_genes <- c("Sell","Il7r","Bcl2","Lef1","S1pr1")
eff_genes
...
goi <- c(surface,eff_genes,exh_genes,tf,chemokines,apoptosis,proliferation,ifnstim,memory_genes) #concatenate all of the genes of interest
